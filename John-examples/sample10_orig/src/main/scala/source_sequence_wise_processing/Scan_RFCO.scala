...
object Scan_RFCO {
  def Scan_RFCO_Graph(spark: SparkSession, out_source_sequence_wise_processing_base_ii_cmls_rfco_data: DataFrame): DataFrame = {
    val variables = Map[String, Any]()
    import spark.implicits._  /* Source Sequence_wise_Processing.Scan_RFCO */
  lazy val t19 = out_source_sequence_wise_processing_base_ii_cmls_rfco_data.select(substring(col("CMLS_CPD_DT"), 3, 2).as("BR_AUDT_YY"),
...
col("*"))
  lazy val t20 = t19.select($"BR_AUDT_YY",
$"BR_AUDT_MM",
$"BR_AUDT_DD",
$"BR_AUDT_TYPE1",
$"BR_AUDT_TYPE2",
...
$"CMLS_SETLMT_CD",
$"BR_AUDT_FILLER")
  lazy val out_source_sequence_wise_processing_scan_rfco = t20
    out_source_sequence_wise_processing_scan_rfco
}
}
}
