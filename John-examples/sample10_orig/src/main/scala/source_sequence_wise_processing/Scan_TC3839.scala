...
object Scan_TC3839 {
  def Scan_TC3839_Graph(spark: SparkSession, out_source_sequence_wise_processing_base2_3839_unix_file: DataFrame): DataFrame = {
    val variables = Map[String, Any]()
    import spark.implicits._  /* Source Sequence_wise_Processing.Scan_TC3839 */
  lazy val t3 = out_source_sequence_wise_processing_base2_3839_unix_file.select(substring(col("CMLS_CPD_DT"), 3, 2).as("BR_AUDT_YY"),
...
col("*"))
  lazy val t4 = t3.select($"BR_AUDT_YY",
$"BR_AUDT_MM",
$"BR_AUDT_DD",
$"BR_AUDT_TYPE1",
$"BR_AUDT_TYPE2",
...
$"CMLS_SETLMT_CD",
$"BR_AUDT_FILLER")
  lazy val out_source_sequence_wise_processing_scan_tc3839 = t4
