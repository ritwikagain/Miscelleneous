...
object Scan_TC40 {
  def Scan_TC40_Graph(spark: SparkSession, out_source_sequence_wise_processing_base2_tc40_unix_file: DataFrame): DataFrame = {
    val variables = Map[String, Any]()
    import spark.implicits._  /* Source Sequence_wise_Processing.Scan_TC40 */
  lazy val t9 = out_source_sequence_wise_processing_base2_tc40_unix_file.select(substring(col("CMLS_CPD_DT"), 3, 2).as("BR_AUDT_YY"),
...
col("*"))
  lazy val t10 = t9.select($"BR_AUDT_YY",
$"BR_AUDT_MM",
$"BR_AUDT_DD",
$"BR_AUDT_TYPE1",
$"BR_AUDT_TYPE2",
...
$"CMLS_SETLMT_CD",
$"BR_AUDT_FILLER")
  lazy val out_source_sequence_wise_processing_scan_tc40 = t10
    out_source_sequence_wise_processing_scan_tc40
}
}
}
