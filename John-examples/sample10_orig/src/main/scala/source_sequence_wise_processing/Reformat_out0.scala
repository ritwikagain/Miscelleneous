...
object Reformat_out0 {
  def Reformat_out0_Graph(spark: SparkSession, out0_source_sequence_wise_processing_reformat: DataFrame): DataFrame = {
    val variables = Map[String, Any]()
    import spark.implicits._  /* Source Sequence_wise_Processing.Reformat_out0 */
  lazy val t27 = out0_source_sequence_wise_processing_reformat.select($"BR_AUDT_YY",
$"BR_AUDT_MM",
$"BR_AUDT_DD",
$"BR_AUDT_TYPE1",
$"BR_AUDT_TYPE2",
...
$"BR_AUDT_AMOUNT_10",
$"BR_AUDT_FILLER")
  lazy val out_source_sequence_wise_processing_reformat_out0 = t27
    out_source_sequence_wise_processing_reformat_out0
}
}
}
