...
object Scan_TC50 {
  def Scan_TC50_Graph(spark: SparkSession, out_source_sequence_wise_processing_base_ii_tc50_data: DataFrame): DataFrame = {
    val variables = Map[String, Any]()
    import spark.implicits._  /* Source Sequence_wise_Processing.Scan_TC50 */
  lazy val t11 = out_source_sequence_wise_processing_base_ii_tc50_data.select(substring(col("CMLS_CPD_DT"), 3, 2).as("BR_AUDT_YY"),
...
col("*"))
  lazy val t12 = t11.select($"BR_AUDT_YY",
$"BR_AUDT_MM",
$"BR_AUDT_DD",
$"BR_AUDT_TYPE1",
$"BR_AUDT_TYPE2",
...
$"CMLS_SETLMT_CD",
$"BR_AUDT_FILLER")
  lazy val out_source_sequence_wise_processing_scan_tc50 = t12
    out_source_sequence_wise_processing_scan_tc50
}
}
}
