...
object Scan_SMSOTC {
  def Scan_SMSOTC_Graph(spark: SparkSession, out_source_sequence_wise_processing_base_ii_smsotc_data: DataFrame): DataFrame = {
    val variables = Map[String, Any]()
    import spark.implicits._  /* Source Sequence_wise_Processing.Scan_SMSOTC */
  lazy val t5 = out_source_sequence_wise_processing_base_ii_smsotc_data.select(substring(col("CMLS_CPD_DT"), 3, 2).as("BR_AUDT_YY"),
...
col("*"))
  lazy val t6 = t5.select($"BR_AUDT_YY",
$"BR_AUDT_MM",
$"BR_AUDT_DD",
$"BR_AUDT_TYPE1",
$"BR_AUDT_TYPE2",
...
$"CMLS_SETLMT_CD",
$"BR_AUDT_FILLER")
  lazy val out_source_sequence_wise_processing_scan_smsotc = t6
    out_source_sequence_wise_processing_scan_smsotc
}
}
}
