...
object Scan_TC1020 {
  def Scan_TC1020_Graph(spark: SparkSession, out_source_sequence_wise_processing_base2_1020_unix_file: DataFrame): DataFrame = {
    val variables = Map[String, Any]()
    import spark.implicits._  /* Source Sequence_wise_Processing.Scan_TC1020 */
  lazy val t7 = out_source_sequence_wise_processing_base2_1020_unix_file.select(substring(col("CMLS_CPD_DT"), 3, 2).as("BR_AUDT_YY"),
...
col("*"))
  lazy val t8 = t7.select($"BR_AUDT_YY",
$"BR_AUDT_MM",
$"BR_AUDT_DD",
$"BR_AUDT_TYPE1",
$"BR_AUDT_TYPE2",
...
$"CMLS_SETLMT_CD",
$"BR_AUDT_FILLER")
  lazy val out_source_sequence_wise_processing_scan_tc1020 = t8
